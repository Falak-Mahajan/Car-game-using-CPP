...
//to set cursor for enemy movement and car movement 
...
//set console cursor size and visbility 
...
void play(){
    ...
    cout<<"A key to go left";
    gotoxy(WIN_WIDTH+7,15);
    cout<<"D key to go right";
    gotoxy(18,5);
    cout<<"-------PRESS AND KEY TO START-------";
    getch();
    gotoxy(18,5);
    cout<<"                       c            ";
